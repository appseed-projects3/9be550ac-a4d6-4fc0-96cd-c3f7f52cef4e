...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-23 14:51`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9be550ac-a4d6-4fc0-96cd-c3f7f52cef4e.git
$ cd 9be550ac-a4d6-4fc0-96cd-c3f7f52cef4e
```
